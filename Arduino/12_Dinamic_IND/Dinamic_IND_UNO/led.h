...
#define ON_LED_0 8
#define reset_ON_LED_0 digitalWrite(ON_LED_0, LOW)
#define set_ON_LED_0 digitalWrite(ON_LED_0, HIGH)

#define ON_LED_1 9
#define reset_ON_LED_1 digitalWrite(ON_LED_1, LOW)
#define set_ON_LED_1 digitalWrite(ON_LED_1, HIGH)

#define ON_LED_2 10
#define reset_ON_LED_2 digitalWrite(ON_LED_2, LOW)
#define set_ON_LED_2 digitalWrite(ON_LED_2, HIGH)

#define ON_LED_3 11
#define reset_ON_LED_3 digitalWrite(ON_LED_3, LOW)
#define set_ON_LED_3 digitalWrite(ON_LED_3, HIGH)
