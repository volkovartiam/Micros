...
.Ltext0:
	...
	.file 0 "D:/MGU/Micros/Micros/Atmega/Programming/Lesson_32/MYPROG32" "src/utils.c"
	.globl	int_to_binary
...
.LFE4:
	.seh_endproc
	.globl	uint32_to_binary
	.def	uint32_to_binary;	.scl	2;	.type	32;	.endef
	.seh_proc	uint32_to_binary
uint32_to_binary:
.LFB5:
	.loc 1 29 1
	.cfi_startproc
...
.L19:
	...
	mov	rdx, rax
	call	strcat
	.loc 1 39 19 discriminator 2
	movzx	eax, BYTE PTR -3[rbp]
	add	eax, 1
	mov	BYTE PTR -3[rbp], al
.L18:
	.loc 1 39 14 discriminator 1
	movzx	eax, BYTE PTR -3[rbp]
	cmp	al, BYTE PTR -2[rbp]
	jb	.L23
	.loc 1 51 1
