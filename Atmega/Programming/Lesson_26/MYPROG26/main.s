...
.Ltext0:
	...
	.file 0 "D:/MGU/Micros/Micros/Atmega/Programming/Lesson_26/MYPROG26" "src/main.c"
...
zf:
	...
	.section .rdata,"dr"
.LC0:
	.ascii "Value a is\11\11"
	.ascii "0x%08X\12\0"
.LC1:
	.ascii "Value p_a is\11\11"
	.ascii "0x%08X\12\0"
.LC2:
	.ascii "Value *p_a is\11\11"
	.ascii "0x%08X\12\0"
...
.LC3:
	.ascii "-------------------------------------\0"
.LC4:
	.ascii "Value b is\11\11"
	.ascii "0x%08X\12\0"
.LC5:
	.ascii "Value uch is\11\11"
	.ascii "0x%08X\12\0"
.LC6:
	.ascii "Value p_uch is\11\11\0"
.LC7:
	.ascii "0x%02X \0"
	.align 8
.LC8:
	.ascii "\12-------------------------------------\0"
.LC9:
	.ascii "Value p_p_a is\11\11"
	.ascii "0x%08X\12\0"
.LC10:
	.ascii "Value *p_p_a is\11\11"
	.ascii "0x%08X\12\0"
.LC11:
	.ascii "Value **p_p_a is\11"
	.ascii "0x%08X\12\0"
	.text
	.globl	main
...
.LFB129:
	...
	call	puts
	.loc 1 57 17
	movabs	rax, -6153737369425722317
	mov	QWORD PTR -54[rbp], rax
	mov	WORD PTR -46[rbp], -13125
	.loc 1 59 3
	lea	rax, -54[rbp]
	mov	edx, eax
	lea	rax, .LC5[rip]
...
.LASF1:
	.ascii "D:\\MGU\\Micros\\Micros\\Atmega\\Programming\\Lesson_26\\MYPROG26\0"
.LASF0:
	.ascii "src/main.c\0"
