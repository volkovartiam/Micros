...
.LFB129:
	...
	call	__main
	.loc 1 32 16
	mov	DWORD PTR -80[rbp], 858993459
	mov	DWORD PTR -76[rbp], 1145324612
	mov	DWORD PTR -72[rbp], 1431655765
	mov	DWORD PTR -68[rbp], 1717986918
	mov	DWORD PTR -64[rbp], 2004318071
	mov	DWORD PTR -60[rbp], -2004318072
	mov	DWORD PTR -56[rbp], -1717986919
	mov	DWORD PTR -52[rbp], -1431655766
	mov	DWORD PTR -48[rbp], -1145324613
	mov	DWORD PTR -44[rbp], -858993460
	.loc 1 34 3
	lea	rax, .LC0[rip]
	mov	rcx, rax
	call	puts
