...
.Ltext0:
	...
	.file 0 "D:/MGU/Micros/Micros/Atmega/Programming/Lesson_31/MYPROG31" "src/student.c"
	.section .rdata,"dr"
.LC0:
	...
	.seh_proc	printStudent
printStudent:
.LFB124:
	.file 1 "src/student.c"
	.loc 1 4 1
	.cfi_startproc
	push	rbp
	.seh_pushreg	rbp
...
.LC1:
	...
	.text
	.globl	printStudentvoid
	.def	printStudentvoid;	.scl	2;	.type	32;	.endef
	.seh_proc	printStudentvoid
printStudentvoid:
.LFB125:
	.loc 1 9 1
	.cfi_startproc
...
.LFE126:
	.seh_endproc
	.globl	addCourse
	.def	addCourse;	.scl	2;	.type	32;	.endef
	.seh_proc	addCourse
addCourse:
.LFB127:
	.loc 1 29 1
...
.LFE127:
	.seh_endproc
	.globl	addAge
	.def	addAge;	.scl	2;	.type	32;	.endef
	.seh_proc	addAge
addAge:
.LFB128:
	.loc 1 34 1
...
.LFE128:
	.seh_endproc
	.globl	modifyName
	.def	modifyName;	.scl	2;	.type	32;	.endef
	.seh_proc	modifyName
modifyName:
.LFB129:
	.loc 1 39 1
...
.LFE129:
	.seh_endproc
	.globl	deletePos
	.def	deletePos;	.scl	2;	.type	32;	.endef
	.seh_proc	deletePos
deletePos:
.LFB130:
	.loc 1 44 1
...
.L9:
	...
	.loc 1 49 23
	mov	BYTE PTR 61[rdx], al
	.loc 1 45 48 discriminator 3
	add	DWORD PTR -4[rbp], 1
.L8:
	.loc 1 45 28 discriminator 1
	mov	rax, QWORD PTR 32[rbp]
	mov	eax, DWORD PTR [rax]
	.loc 1 45 44 discriminator 1
	sub	eax, 1
...
.Letext0:
	...
	.file 3 "D:/mingw64/x86_64-w64-mingw32/include/string.h"
	.file 4 "D:/mingw64/x86_64-w64-mingw32/include/stdio.h"
...
.LASF1:
	.ascii "D:\\MGU\\Micros\\Micros\\Atmega\\Programming\\Lesson_31\\MYPROG31\0"
.LASF0:
	.ascii "src/student.c\0"
