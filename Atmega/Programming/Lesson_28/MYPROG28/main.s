...
.Ltext0:
	...
	.file 0 "D:/MGU/Micros/Micros/Atmega/Programming/Lesson_28/MYPROG28" "src/main.c"
...
zf:
	...
	.section .rdata,"dr"
.LC0:
	.ascii "%s,\11%d \352\363\360\361,\11%d \353\345\362\12\0"
.LC1:
	.ascii "%s,\11%d \352\363\360\361,\11%d \353\345\362\0"
	.text
	.globl	main
...
.LFB129:
	...
	.loc 1 47 3
	lea	rax, -32[rbp]
	movabs	rdx, -1887253559801485873
	mov	QWORD PTR [rax], rdx
	movabs	rcx, -1230079858577444622
	mov	QWORD PTR 8[rax], rcx
	mov	DWORD PTR 16[rax], 16247010
	.loc 1 48 11
	mov	BYTE PTR 28[rbp], 17
	.loc 1 49 14
	...
	.loc 1 56 3
	movabs	rdx, 2369719059482469841
	mov	QWORD PTR [rax], rdx
	movabs	rcx, -2251200592985791544
	mov	QWORD PTR 8[rax], rcx
	movabs	rdx, -582966674325772047
	mov	QWORD PTR 16[rax], rdx
	mov	BYTE PTR 24[rax], 0
	.loc 1 57 14
	mov	rax, QWORD PTR 104[rbp]
	mov	BYTE PTR 60[rax], 20
	.loc 1 58 17
	mov	rax, QWORD PTR 104[rbp]
	mov	BYTE PTR 61[rax], 3
	.loc 1 59 68
	mov	rax, QWORD PTR 104[rbp]
	movzx	eax, BYTE PTR 60[rax]
	.loc 1 59 3
...
.LASF1:
	.ascii "D:\\MGU\\Micros\\Micros\\Atmega\\Programming\\Lesson_28\\MYPROG28\0"
.LASF0:
	.ascii "src/main.c\0"
