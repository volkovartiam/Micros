...
#define SA_SET HAL_GPIO_WritePin(GPIOA, SA, GPIO_PIN_RESET);
#define SA_RESET HAL_GPIO_WritePin(GPIOA, SA, GPIO_PIN_SET);
...
#define SF_SET HAL_GPIO_WritePin(GPIOA, SF, GPIO_PIN_RESET);
#define SF_RESET HAL_GPIO_WritePin(GPIOA, SF, GPIO_PIN_SET);
#define SG_SET HAL_GPIO_WritePin(GPIOA, SG, GPIO_PIN_RESET);
#define SG_RESET HAL_GPIO_WritePin(GPIOA, SG, GPIO_PIN_SET);
